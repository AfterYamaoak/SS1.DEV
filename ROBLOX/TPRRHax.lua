...
Sound:CreateButton("Play Sound", function()
    ...
    ReplicatedStorage.Events.AnimatronicSound:FireServer("SS1 Was Here", getgenv().Config.SoundId, getgenv().Config.Volume, getgenv().Config.Type, getgenv().Config.Pitch)
...
Sound:CreateButton("Stop Sound", function()
    ReplicatedStorage.Events.AnimatronicSoundLoopStop:FireServer("SS1 Was Here")
...
LibCreator:CreateTextLabel("SS1#5201 @ discord.com")

ScriptCreator:CreateTextLabel("SS1#5201 @ discord.com")
...
--loadstring(game:HttpGet("https://raw.githubusercontent.com/AfterYamaoak/SS1.DEV/main/ROBLOX/TPRRHax.lua"))()
